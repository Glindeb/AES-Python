...
implementation in Python 3.10 (also tested in 3.9) (no external libraries needed)
...
__date__ = '2022-07-23'
__description__ = 'AES (Advanced Encryption Standard) implementation in Python-3'
