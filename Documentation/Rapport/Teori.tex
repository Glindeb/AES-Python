...
och \gls{pseudoslump} nummer generatorer bland annat, då eftersom blockskifferets resulterande skiffertext ser ut att vara helt slumpmässig
...
kryptografiskt perspektiv för den slutliga skiffer texten.\footcite{aes_wiki}

\begin{wrapfigure}{r}{0.5\textwidth}
    \centering
    \includegraphics[width=0.8\linewidth]{AES_(Rijndael)_Round_Function.png}
    \caption{Vanlig runda \cite{rounds-picture}}
...
inte ska användas flera gånger vilket skulle göra det enklare att bryta krypteringen.\footcite{aes_wiki}
...
Anledningen till att \nameref{sec:aes-addroundkey} och \nameref{sec:aes-subbytes} inte kräver någon invers operation handlar om hur dessa operationer
...
blir att använda den inversa \nameref{sec:aes-sbox}en.\footcite{aes_wiki}

Både krypterings och dekrypterings strukturen av ett block som beskrivits ovan kan representeras i \gls{python} kod på följande sätt i figur \ref{fig:encryption-rounds-function} \& \ref{fig:decryption-rounds-function}.
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{AES-SubBytes.png}
    \caption{SubBytes operationen \cite{subbytes-pic-ref}}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{AES-ShiftRows.png}
    \caption{ShiftRows operationen \cite{shiftrows-pic-ref}}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{AES-MixColumns.png}
    \caption{MixColumns operationen \cite{mixcolums-pic-ref}}
