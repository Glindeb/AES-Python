...
\subsubsection{MixColumns operationen} %(May need some glossary entrys)
...
vilket tillsammans med ShiftRows operationen ser till så att inte bara enskilda bytes krypteras utan hela matrisen tillsammans.\footcite{daemen1999aes} Själva operationen visas i figur \ref{fig:aes-mixcolumns-pic}
...
Nyckel utökningen är den operation som används för att utöka den angivna nyckeln till antingen 10, 12 eller 14 nycklar beroende på längden av den angivna nyckeln.
Nyckel utökningen är en viktig del av AES som ser till att det finns en unik nyckel för varje runda i krypteringsprocessen.\footcite{daemen1999aes}

Själva utökningen av nyckeln genomförs genom att först dela upp den ursprungliga nyckeln i 4 så kallade words. Varje word består av 4 \gls{byte} och är därmed 32 \gls{bit}s långa.
Där efter så genereras varje nytt word...
