...
lägga till ett extra steg utöver vad som finns i \acrshort{ecb}. Det här steget
...
något föregående block att använda. Hela den här processen kan även ses i
Figur \ref{fig:cbc-mode-enc}.
...
Även detta går att matematiskt formulera såhär:
