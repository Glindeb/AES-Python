...
Där $S_i$ är det krypterade blocket(skiffertexten), $B_i$ är det blocket som ska krypteras, % ######### Allt innan detta stycke är kontrollerat genom word ##########
...
på vilken av det tre \acrshort{aes} varianterna som används.\footfullcite{daemen1999aes}
