...
för en del av sina operationer. S-Boxen kan man se som en slags uppslagstabell
som används för att byta ut ett värde mot ett annat. S-Boxen används huvudsakligen
för att byta ut värden i \nameref{sec:aes-key-expansion} delen av \acrshort{aes} algoritmen
