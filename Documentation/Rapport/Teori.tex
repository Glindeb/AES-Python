...
En ut av de sörsta problemen med är att oavsett hur säkra dom är så passar det bara att använda
för kryptering av enskilda block med en nyckel, vilket skiljer sig från något som ett \gls{streamcipher}.\footfullcite{blockskiffer-ref}


...\footcite{blockskiffer-ref}% need to add more
