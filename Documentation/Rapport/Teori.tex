...
Medans exempel på asymmetriska krypteringsalgoritmer är bland annat \gls{rsa}.\footfullcite{rsa-ref}
...
Anledningen till att \nameref{sec:aes-addroundkey} och \nameref{sec:aes-subbytes} inte kräver någon direkt motsatt funktion handlar om hur dessa operationer
