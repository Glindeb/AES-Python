...
genereras en text fil på 1 MB fylld med slumpmässiga \gls{byte}s. Denna text fil krypteras sedan med hjälp av \acrshort{aes} samtidigt
som tiden som det tar att kryptera filen mätas. Detta upprepas sedan som tidigare nämnts 25 gånger för följande tre nycklarna som går att se nedan.
För \acrshort{cbc} \& \acrshort{ofb} körlägen så används utöver dessa nycklar även en \acrshort{iv} som är 128 bit lång.
