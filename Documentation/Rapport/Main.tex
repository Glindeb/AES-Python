...
\newglossaryentry{xor}
{
    ...
    innebär att termerna bara kan vara 0 eller 1 och resultatet det samma.\cite{xor}} % Maybe needs to be refined
 }
...
\newglossaryentry{python}
{
 ...
 \newglossaryentry{keystream}
 {
  ...
  \newglossaryentry{bit}
  {
       ...
       En bit kan endast ha två värden där den antingen är 0 eller 1. I datorvetenskap pratar
       man dock mer vanligen om ett \gls{byte} som är 8 bits.\cite{bit-ref}}
   }
  ...
  {
      name=Polyalfabetiska skiffer,
      description={Polyalfabetiska skiffer bygger på att man använder flera olika \gls{substitutionsskiffer} för att
