...
{
    name=Caesarchiffer,
    description={Caesarchiffer är ett substitutions Caesarchiffer,
...
\newglossaryentry{xor}
{
    ...
    med den enda skillnaden att 1 xor 1 = 0. Detta samt att xor är en binär operation, vilket
